        ...
        <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-8">
            ...
            <button 
              onClick={runTest}
              disabled={loading}
              className="w-full group bg-white text-black py-5 rounded-3xl font-black text-xs uppercase tracking-widest hover:scale-[1.01] active:scale-95 transition-all flex items-center justify-center gap-3"
            >
